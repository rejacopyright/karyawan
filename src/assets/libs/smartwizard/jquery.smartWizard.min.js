...
$(function(t, s, e, n) {
    ...
    t.extend(i.prototype, {
        init: function() {
            ...
            e > 0 && this.options.anchorSettings.markDoneStep && this.options.anchorSettings.markAllPreviousStepsAsDone && this.steps.eq(e).parent("li").prevAll().addClass("done");
            this._showStep(e);
        },
        _setElements: function() {
            ...
            var s = this;
            this.options.disabledSteps && this.options.disabledSteps.length > 0 && t.each(this.options.disabledSteps, function(t, e) {
        ...
        _setToolbar: function() {
            ...
            var s = this.options.toolbarSettings.showNextButton !== !1 ? t("<button></button>").text(this.options.lang.next).addClass("btn btn-primary btn-sm width-xs sw-btn-next").attr("type", "button") : null,
                e = this.options.toolbarSettings.showPreviousButton !== !1 ? t("<button></button>").text(this.options.lang.previous).addClass("btn btn-primary btn-sm width-xs sw-btn-prev").attr("type", "button") : null,
                n = t("<div></div>").addClass("btn-group mr-2 sw-btn-group").attr("role", "group").append(e, s),
                i = null;
            this.options.toolbarSettings.toolbarExtraButtons && this.options.toolbarSettings.toolbarExtraButtons.length > 0 && (i = t("<div></div>").addClass("btn-group mr-2 sw-btn-group-extra").attr("role", "group") &&
            ...
            switch (this.options.toolbarSettings.toolbarPosition) {
                ...
                case "both":
                    ...
                    break;
                default:
                    a = t("<div></div>").addClass("btn-toolbar sw-toolbar sw-toolbar-bottom justify-content-" + this.options.toolbarSettings.toolbarButtonPosition);a.append(n);a.append(i);this.container.after(a);
            }
            return !0;
        },
        _setEvents: function() {
        ...
        _showStep: function(t) {
            return !!this.steps.eq(t) && (t !== this.current_index && (!this.steps.eq(t).parent("li").hasClass("disabled") && !this.steps.eq(t).parent("li").hasClass("hidden") && (this._loadStepContent(t))))
        },
                ...
                var r = o.length > 0 ? t(o.attr("href"), this.main) : null,
                    h = t.extend(!0, {}, {
                        ...
                        success: function(t) {
                            ...
                            e._loader("hide");e._transitPage(s)
                        }
        ...
        _transitPage: function(s) {
            ...
            return ((0 === s) ? (h = "first") : (s === (this.steps.length - 1)) && (h = "final"), this.options.transitionEffect = this.options.transitionEffect.toLowerCase(), this.pages.finish()) && ("slide" === this.options.transitionEffect) ? (i && (i.length > 0)) ? i.slideUp("fast", this.options.transitionEasing, function() {
                ...
                t(this).show()
            }) : (i && i.length > 0 && i.hide(), a.show()) && (this._setURLHash(o.attr("href")), this._setAnchor(s), this._setButtons(s), this._fixHeight(s), this.current_index = s, this._triggerEvent("showStep", [o, this.current_index, r, h]))
        },
        _setAnchor: function(t) {
            return (this.steps.eq(this.current_index).parent("li").removeClass("active"), this.options.anchorSettings.markDoneStep !== !1 && null !== this.current_index && (this.steps.eq(this.current_index).parent("li").addClass("done"), this.options.anchorSettings.removeDoneStepOnNavigateBack !== !1 && this.steps.eq(t).parent("li").nextAll().removeClass("done")), this.steps.eq(t).parent("li").removeClass("done").addClass("active"))
        },
        _setButtons: function(s) {
            return this.options.cycleSteps || (0 >= s ? t(".sw-btn-prev", this.main).addClass("bg-soft-primary text-primary no-drop") : t(".sw-btn-prev", this.main).removeClass("bg-soft-primary text-primary no-drop"), this.steps.length - 1 <= s ? t(".sw-btn-next", this.main).addClass("bg-soft-primary text-primary no-drop") : t(".sw-btn-next", this.main).removeClass("bg-soft-primary text-primary no-drop"))
        },
        _keyNav: function(t) {
            var s = this;
            switch (t.which) {
