    ...
    return (
      <div className="left-side-menu">
        <div className="media user-profile mt-2 mb-2">
          <img src={require("../assets/images/users/avatar-7.jpg")} className="avatar-sm rounded-circle mr-2" alt="Admin" />
          <img src={require("../assets/images/users/avatar-7.jpg")} className="avatar-xs rounded-circle mr-2" alt="Admin" />
          <div className="media-body">
            <h6 className="pro-user-name mt-0 mb-0">Reja Jamil</h6>
        ...
        <div className="sidebar-content">
          <div id="sidebar-menu" className="slimscroll-menu">
            <ul className="metismenu" id="menu-bar">
              <li> <Link to="/"> <i data-feather="home"></i> <span className="badge badge-success float-right">1</span> <span> Dashboard </span> </Link> </li>
              <li>
                <Link to="/user"> <i data-feather="user" /> <span> User </span> <span className="menu-arrow"></span> </Link>
                <ul className="nav-second-level" aria-expanded="false">
                  <li> <Link to="/user/list">User List</Link> </li>
                  <li> <Link to="/user/add">Add User</Link> </li>
                </ul>
              </li>
              <li> <Link to="/calendar"> <i data-feather="calendar"></i> <span> Report </span> </Link> </li>
