    ...
    return(
      <form onSubmit={this.onSubmit.bind(this)}>
        ...
        <div className="row">
          ...
          <Input sm rowClass="col-md-6 mb-2" name="name" title="Nama Jabatan" placeholder="Nama Jabatan" autoFocus />
          <Desimal sm rowClass="col-md-6 mb-2" name="salary" title="Basic Salary" placeholder="Basic Salary" icon="Rp." />
