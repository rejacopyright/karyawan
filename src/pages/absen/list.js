        ...
        <ul className="message-list mb-1">
          <li className="h-unset lh-unset radius-5">
            <div className="row m-0 p-2 align-items-center right-bar-toggle pointer">
              <Link className="col-atuo" to={`/absen/detail/${this.props.userID}`} >
                {
                  this.props.avatar ?
              ...
              <Link className="col-md-2 col-auto" to={`/absen/detail/${this.props.userID}`}>
              ...
              <Link className="col text-truncate" to={`/absen/detail/${this.props.userID}`}>
                <div className="subject f-600 text-8"> {this.props.userDesc} </div>
              </Link>
              <Link className="col text-right text-7 text-dark pr-0" to={`/absen/detail/${this.props.userID}`} >{this.props.time}</Link>
